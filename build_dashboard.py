...
(اختيار من/إلى، والافتراضي هو اليوم مقابل الأمس: آخر يومين في الأرشيف)، مع أعمدة
موسومة بالتواريخ الفعلية المقارنة (ليس قبل/بعد غامضة)، وألوان: صعود السعر
= أخضر، نزوله = أحمر، وجدول منفصل مرتّب لكل كاتوجري يضم الأسعار والنسب ونسبة
